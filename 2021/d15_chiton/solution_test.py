...
from d15_chiton.solution import find_a_route_with_the_lowest_risk, CavernMap, ExtendedCavernMap
...
class ChitonTestCase(unittest.TestCase):
    ...
    def test_part_2_calculation_with_sample_input(self):
        cavern_map = [
            [1, 1, 6, 3, 7, 5, 1, 7, 4, 2],
            [1, 3, 8, 1, 3, 7, 3, 6, 7, 2],
            [2, 1, 3, 6, 5, 1, 1, 3, 2, 8],
        ...
        c_map = ExtendedCavernMap(cavern_map)
        risk = find_a_route_with_the_lowest_risk(c_map)
